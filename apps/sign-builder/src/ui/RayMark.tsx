...
// bottom-left. Ported verbatim from the Sign Builder Pro Preview app
// (alexsmith0416/Sign-Builder-Pro-Preview-) so the sub-app's brand matches
// the rest of the Lumineo code-app fleet.
