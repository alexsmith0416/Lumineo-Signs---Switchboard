...
const SAMPLE: LniRecord[] = [
  {
    ...
    description:'', mfgFinalDate:'', dateToHold:'', dateOffHold:'', dateInstalled:'', dateToAdmin:'',
    vendorShipDate2:'', outsourcedArrival:'', paintPrepDueMod:'', cutVinylColor:'', vinylProd:'', mfgTarget:'', installTarget:'', billDayJob:'', sketch:'', routingOrdered:'', vinylOrdered:'', vinylComplete:'', routingComplete:'', mfgComplete:'', dateInvoiced:'', vinylDueDate:'', vinylProdStartDate:'', graphicsNotes:'', emcContent:'', mfgRating:'', adjustedDip:null, mfgDip:null,
...
function toEntity(r: LniRecord): Record<string, unknown> {
  return {
    ...
    lni_description: r.description, lni_mfg_final_date: r.mfgFinalDate,
    lni_date_to_hold: r.dateToHold, lni_date_off_hold: r.dateOffHold,
    lni_date_installed: r.dateInstalled, lni_date_to_admin: r.dateToAdmin,
    lni_vendor_ship_date2: r.vendorShipDate2, lni_outsourced_arrival: r.outsourcedArrival,
    lni_paint_prep_due_mod: r.paintPrepDueMod, lni_cut_vinyl_color: r.cutVinylColor,
    lni_vinyl_prod: r.vinylProd,
    lni_mfg_target: r.mfgTarget, lni_install_target: r.installTarget,
    lni_bill_day_job: r.billDayJob, lni_sketch: r.sketch,
    lni_routing_ordered: r.routingOrdered, lni_vinyl_ordered: r.vinylOrdered,
    lni_vinyl_complete: r.vinylComplete, lni_routing_complete: r.routingComplete,
    lni_mfg_complete: r.mfgComplete, lni_date_invoiced: r.dateInvoiced,
    lni_vinyl_due_date: r.vinylDueDate, lni_vinyl_prod_start_date: r.vinylProdStartDate,
    lni_graphics_notes: r.graphicsNotes, lni_emc_content: r.emcContent,
    lni_mfg_rating: r.mfgRating, lni_adjusted_dip: r.adjustedDip, lni_mfg_dip: r.mfgDip,
  };
}
...
const COL_TO_KEY: Record<string, string> = {
  ...
  lni_description:'description', lni_mfg_final_date:'mfgFinalDate',
  lni_date_to_hold:'dateToHold', lni_date_off_hold:'dateOffHold',
  lni_date_installed:'dateInstalled', lni_date_to_admin:'dateToAdmin',
  lni_vendor_ship_date2:'vendorShipDate2', lni_outsourced_arrival:'outsourcedArrival',
  lni_paint_prep_due_mod:'paintPrepDueMod', lni_cut_vinyl_color:'cutVinylColor',
  lni_vinyl_prod:'vinylProd',
  lni_mfg_target:'mfgTarget', lni_install_target:'installTarget',
  lni_bill_day_job:'billDayJob', lni_sketch:'sketch',
  lni_routing_ordered:'routingOrdered', lni_vinyl_ordered:'vinylOrdered',
  lni_vinyl_complete:'vinylComplete', lni_routing_complete:'routingComplete',
  lni_mfg_complete:'mfgComplete', lni_date_invoiced:'dateInvoiced',
  lni_vinyl_due_date:'vinylDueDate', lni_vinyl_prod_start_date:'vinylProdStartDate',
  lni_graphics_notes:'graphicsNotes', lni_emc_content:'emcContent',
  lni_mfg_rating:'mfgRating', lni_adjusted_dip:'adjustedDip', lni_mfg_dip:'mfgDip',
};
