...
function mapFromDV(entity: Record<string, unknown>): LniRecord {
  ...
  return {
    ...
    description:     s('lni_description'),
    mfgFinalDate:    s('lni_mfg_final_date'),
    dateToHold:      s('lni_date_to_hold'),
    dateOffHold:     s('lni_date_off_hold'),
    dateInstalled:   s('lni_date_installed'),
    dateToAdmin:     s('lni_date_to_admin'),
    vendorShipDate2: s('lni_vendor_ship_date2'),
    outsourcedArrival: s('lni_outsourced_arrival'),
    paintPrepDueMod: s('lni_paint_prep_due_mod'),
    cutVinylColor:   s('lni_cut_vinyl_color'),
    vinylProd:       s('lni_vinyl_prod'),
    // Scheduling dates
    mfgTarget:       s('lni_mfg_target'),
    installTarget:   s('lni_install_target'),
    billDayJob:      s('lni_bill_day_job'),
    // Workflow
    sketch:          s('lni_sketch'),
    routingOrdered:  s('lni_routing_ordered'),
    vinylOrdered:    s('lni_vinyl_ordered'),
    vinylComplete:   s('lni_vinyl_complete'),
    routingComplete: s('lni_routing_complete'),
    mfgComplete:     s('lni_mfg_complete'),
    dateInvoiced:    s('lni_date_invoiced'),
    vinylDueDate:    s('lni_vinyl_due_date'),
    vinylProdStartDate: s('lni_vinyl_prod_start_date'),
    // Notes / supplemental
    graphicsNotes:   s('lni_graphics_notes'),
    emcContent:      s('lni_emc_content'),
    mfgRating:       s('lni_mfg_rating'),
    // DIP sub-metrics
    adjustedDip:     n('lni_adjusted_dip'),
    mfgDip:          n('lni_mfg_dip'),
  };
}
...
const DV_COLUMN: Record<string, string> = {
  ...
  description:     'lni_description',
  mfgFinalDate:    'lni_mfg_final_date',
  dateToHold:      'lni_date_to_hold',
  dateOffHold:     'lni_date_off_hold',
  dateInstalled:   'lni_date_installed',
  dateToAdmin:     'lni_date_to_admin',
  vendorShipDate2: 'lni_vendor_ship_date2',
  outsourcedArrival: 'lni_outsourced_arrival',
  paintPrepDueMod: 'lni_paint_prep_due_mod',
  cutVinylColor:   'lni_cut_vinyl_color',
  vinylProd:       'lni_vinyl_prod',
  mfgTarget:       'lni_mfg_target',
  installTarget:   'lni_install_target',
  billDayJob:      'lni_bill_day_job',
  routingOrdered:  'lni_routing_ordered',
  vinylOrdered:    'lni_vinyl_ordered',
  vinylComplete:   'lni_vinyl_complete',
  routingComplete: 'lni_routing_complete',
  mfgComplete:     'lni_mfg_complete',
  dateInvoiced:    'lni_date_invoiced',
  vinylDueDate:    'lni_vinyl_due_date',
  vinylProdStartDate: 'lni_vinyl_prod_start_date',
  graphicsNotes:   'lni_graphics_notes',
  emcContent:      'lni_emc_content',
  mfgRating:       'lni_mfg_rating',
};
