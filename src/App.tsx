...
// Data source — controlled by VITE_DATA_SOURCE at build time:
//   'airtable'  → live Airtable API (dev proxy on localhost, direct call in prod)
//   'dataverse' → live Dataverse tables (future)
//   'static' or unset → bundled CSV snapshot, no network (demo / default)
const useData =
  import.meta.env.VITE_DATA_SOURCE === 'airtable'  ? useAirtable  :
  import.meta.env.VITE_DATA_SOURCE === 'dataverse' ? useDataverse :
  useStaticData;
